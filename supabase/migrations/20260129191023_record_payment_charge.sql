-- ============================================
-- RECORD_PAYMENT AND RECORD_CHARGE FUNCTIONS
-- ============================================
-- Phase 4 Plan 02: Fee Structures & Charges
--
-- These functions create properly balanced double-entry transactions:
--
-- record_payment():
--   Debit  Operating Bank (1010)  +amount
--   Credit Accounts Receivable    -amount
--
-- record_charge():
--   Debit  Accounts Receivable    +amount
--   Credit Income Account         -amount
...
-- Creates balanced double-entry: Debit Bank, Credit Receivable
...
-- ============================================
-- Records a charge to a unit (fee, assessment, etc.)
-- Creates balanced double-entry: Debit Receivable, Credit Income
