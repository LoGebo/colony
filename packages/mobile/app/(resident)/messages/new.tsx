...
export default function NewConversationScreen() {
  ...
  // Fetch residents with user_id
  const { data: contacts, isLoading } = useQuery({
    queryKey: [...queryKeys.residents.list(communityId!).queryKey, 'chat-contacts'],
    queryFn: async () => {
      ...
      const guards: ContactItem[] = (guardsRes.data ?? [])
        ...
        >
          ...
          <View style={styles.contactInfo}>
            ...
            <Text style={styles.contactType}>
              {item.type === 'guard' ? 'Guard' : 'Resident'}
            </Text>
          </View>
        </TouchableOpacity>
      );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/(resident)/messages/create-group')}
        >
