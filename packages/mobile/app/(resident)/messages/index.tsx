...
export default function MessagesIndexScreen() {
  ...
  const handleConversationPress = useCallback(
    (conversationId: string) => {
      router.push(`/(resident)/messages/${conversationId}`);
    },
    [router]
  );
  ...
  const keyExtractor = useCallback(
    (item: ConversationListItem) => item.conversation_id,
    []
  );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/(resident)/messages/new')}
          activeOpacity={0.8}
        >
          ...
          isLoading ? (
            ...
            <View style={styles.centerMessage}>
              ...
              <Text style={styles.emptySubtitle}>
                Start a conversation with a neighbor or guard.
              </Text>
            </View>
          )
        }
...
const styles = StyleSheet.create({
  ...
  separator: {
    ...
    marginLeft: spacing.pagePaddingX + 48 + spacing.lg,
    marginRight: spacing.pagePaddingX,
  },
  centerMessage: {
    alignItems: 'center',
    justifyContent: 'center',
